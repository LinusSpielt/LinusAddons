package net.linusaddons.mod.features.generic;
...
import net.linusaddons.mod.LAConstants;
...
import net.linusaddons.mod.events.impl.skyblock.KuudraRunEndEvent;
...
public class DiscordRPCFeature extends Feature {
    ...
    private static final String KUUDRA_NET_URL = "https://discord.gg/fJeDhZbv2a";
    private static final String KUUDRA_NET_LABEL = "Discord";
    ...
    private void startSession() {
        ...
        DiscordRPCIntegration.INSTANCE.connect(LAConstants.DISCORD_RPC_ID);
    ...
    private void updatePresenceInKuudra() {
        ...
        String state = phase.getDisplayName() + " Phase";
        ...
        DiscordRichPresence presence = DiscordRichPresence.builder()
                ...
                .largeImageKey("logo")
                .largeImageText("LinusAddons 26.1.2")
