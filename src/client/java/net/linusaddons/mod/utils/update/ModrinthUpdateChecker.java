package net.linusaddons.mod.utils.update;
...
import net.linusaddons.mod.utils.MessageUtil;
...
public final class ModrinthUpdateChecker {
    ...
    private static final String MODRINTH_PROJECT_SLUG = "linus-addons";
    private static final String MODRINTH_PROJECT_URL = "https://modrinth.com/mod/" + MODRINTH_PROJECT_SLUG;
    private static final String USER_AGENT = "LinusAddons/" + currentVersion() + " (https://github.com/LinusSpielt/LinusAddons)";

    public static final ModrinthUpdateChecker INSTANCE = new ModrinthUpdateChecker();

    private final ScheduledExecutorService executor = Executors.newSingleThreadScheduledExecutor(r -> {
        Thread thread = new Thread(r, "linusaddons-modrinth-update-checker");
