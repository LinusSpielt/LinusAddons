package net.linusaddons.mod.hud;

import lombok.Getter;
import lombok.Setter;
import lombok.extern.slf4j.Slf4j;
import net.linusaddons.mod.hud.config.HudElementConfig;
import net.linusaddons.mod.hud.element.HudElement;
...
public class HudEditScreen extends Screen {
    ...
    private static final String TITLE = "LA HUD Editor";
