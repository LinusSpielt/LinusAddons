package net.linusaddons.mod.model.kuudra;
...
public enum KuudraPhase {
    ...
    public static final Set<KuudraPhase> REND_PHASES = EnumSet.of(SKIP, BOSS);
    public static final Set<KuudraPhase> DPS_PHASES = EnumSet.of(EATEN, STUN, DPS);
