...
import static net.linusaddons.mod.LAModClient.mc;
        ...
        if (ticksRemaining > 0) {
            ...
            if (ticksRemaining <= 0) {
                ...
                if (mc.player != null) {
                    ...
                    String armor = mc.player.getItemBySlot(EquipmentSlot.HEAD).getHoverName().getString();
                    mc.player.sendSystemMessage(Component.literal("§l§8[§r§cL§6A§l§8] §r§fBack bone hit | Holding - " + held + " | Wearing - " + armor));
                }
            }
        }
